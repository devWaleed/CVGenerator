const data = {
  jobs: [
    ...
    {
      organization: "ITVariables",
      roles: [
        {
          title: "Full Stack Developer (.NET, PHP Laravel, Wordpress)",
          description:
            "Worked with a small team of developers on multiple international client projects",
          duration: "Feb 2017 - Jan 2018 - 1 yr",
          projects: [],
        },
      ],
    },
    {
      organization: "Biz World Solutions",
      roles: [
        {
          title: "Full Stack Developer (.NET, PHP Laravel, Wordpress)",
          description:
